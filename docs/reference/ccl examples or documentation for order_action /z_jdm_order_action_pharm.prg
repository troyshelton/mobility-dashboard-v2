...
DROP PROGRAM   Z_JDM_ORDER_ACTION_PHARM : DBA  GO
CREATE PROGRAM  Z_JDM_ORDER_ACTION_PHARM : DBA 
prompt 
	...
	, "Select the desired user (selecting any will run for all users in the system):" = ""
