...
;===============================================================================
; Program: 1_cust_mp_mob_get_pdata_12.prg
; Version: v12
; Build Date: 2026-01-12
; Project: Mobility Dashboard v2.8.0-mobility
; Issue: #20 - Clinician Feedback Enhancements (2026-01-06 Meeting)
;
; Features: demographics, patient-list-integration, 30-day-lookback, 11-clinical-events, activity-precautions, historical-arrays, bmat-parsing, baseline-mobility, toileting-method, pt-ot-transfers, ambulation-distance, ambulation-personnel, powerform-discrete-grid, order-detection
;
...
;
; Changelog v12:
;   - ADDED: Personnel who charted for Ambulation Distance (Issue #20)
;   - ADDED: performed_by and performed_position to ambulation_history array
;   - ADDED: JOIN to prsnl table in SELECT 2 for performer lookup
;   - Purpose: Show if PT, OT, Nursing, or Cardiac Rehab documented ambulation
;   - Based on v11 with personnel enhancement for ambulation
;
; Date Filtering:
