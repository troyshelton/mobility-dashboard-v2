...
;===============================================================================
; Program: 1_cust_mp_mob_get_pdata_14.prg
; Version: v14
; Build Date: 2026-01-13
; Project: Mobility Dashboard v2.10.0-mobility
; Issue: #24 - Transfer Type & Patient Position Activity
;
; Features: demographics, patient-list-integration, 30-day-lookback, 13-clinical-events, activity-precautions, historical-arrays, bmat-parsing, baseline-mobility, toileting-method, pt-ot-transfers, ambulation-distance, ambulation-personnel, powerform-discrete-grid, order-detection, powerform-activity-links, transfer-type, position-activity
;
; Description: Get patient demographics + 13 clinical events with 30-day historical data
...
DECLARE PROGRAM_VERSION = vc WITH CONSTANT("v14"), PROTECT
DECLARE BUILD_DATE = vc WITH CONSTANT("2026-01-13"), PROTECT
DECLARE PROGRAM_FEATURES = vc WITH CONSTANT("demographics,patient-list-integration,30-day-lookback,13-clinical-events,activity-precautions,historical-arrays,side-panel,bmat-parsing,baseline-mobility,toileting-method,pt-ot-transfers,ambulation-distance,ambulation-personnel,powerform-discrete-grid,order-detection,six-select,powerform-activity-links,transfer-type,position-activity"), PROTECT
