...
;===============================================================================
; Program: 1_cust_mp_mob_get_pdata_08.prg
; Version: v08
; Build Date: 2026-01-02
; Project: Mobility Dashboard v2.3.0-mobility
; Issue: #8 - Add Baseline Mobility Column (PowerForm)
;
; Features: demographics, patient-list-integration, 30-day-lookback, 7-clinical-events, activity-precautions, historical-arrays, bmat-parsing, baseline-mobility, order-detection
;
; Description: Get patient demographics + 7 clinical events with 30-day historical data
...
DECLARE PROGRAM_VERSION = vc WITH CONSTANT("v08"), PROTECT
DECLARE BUILD_DATE = vc WITH CONSTANT("2026-01-02"), PROTECT
DECLARE PROGRAM_FEATURES = vc WITH CONSTANT("demographics,patient-list-integration,30-day-lookback,7-clinical-events,activity-precautions,historical-arrays,side-panel,bmat-parsing,baseline-mobility,order-detection,four-select"), PROTECT
