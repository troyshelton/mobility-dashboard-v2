...
;===============================================================================
; Program: 1_cust_mp_mob_get_pdata_11.prg
; Version: v11
; Build Date: 2026-01-03
; Project: Mobility Dashboard v2.6.0-mobility
; Issue: #16 - Add Ambulation Distance Column
;
; Features: demographics, patient-list-integration, 30-day-lookback, 11-clinical-events, activity-precautions, historical-arrays, bmat-parsing, baseline-mobility, toileting-method, pt-ot-transfers, ambulation-distance, powerform-discrete-grid, order-detection
;
...
DECLARE PROGRAM_VERSION = vc WITH CONSTANT("v11"), PROTECT
DECLARE BUILD_DATE = vc WITH CONSTANT("2026-01-03"), PROTECT
DECLARE PROGRAM_FEATURES = vc WITH CONSTANT("demographics,patient-list-integration,30-day-lookback,11-clinical-events,activity-precautions,historical-arrays,side-panel,bmat-parsing,baseline-mobility,toileting-method,pt-ot-transfers,ambulation-distance,powerform-discrete-grid,order-detection,six-select"), PROTECT
