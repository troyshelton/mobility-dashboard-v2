...
;===============================================================================
; Program: 1_cust_mp_mob_get_pdata_09.prg
; Version: v09
; Build Date: 2026-01-02
; Project: Mobility Dashboard v2.4.0-mobility
; Issue: #9 - Add Toileting Method Column (I-View Documentation)
;
; Features: demographics, patient-list-integration, 30-day-lookback, 8-clinical-events, activity-precautions, historical-arrays, bmat-parsing, baseline-mobility, toileting-method, order-detection
;
; Description: Get patient demographics + 8 clinical events with 30-day historical data
;              Uses FOUR SELECT statements: (1) Demographics, (2) Clinical Events, (3) BMAT, (4) Activity Precautions
...
DECLARE PROGRAM_VERSION = vc WITH CONSTANT("v09"), PROTECT
DECLARE BUILD_DATE = vc WITH CONSTANT("2026-01-02"), PROTECT
DECLARE PROGRAM_FEATURES = vc WITH CONSTANT("demographics,patient-list-integration,30-day-lookback,8-clinical-events,activity-precautions,historical-arrays,side-panel,bmat-parsing,baseline-mobility,toileting-method,order-detection,four-select"), PROTECT
