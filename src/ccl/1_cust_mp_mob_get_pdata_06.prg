...
;===============================================================================
; Program: 1_cust_mp_mob_get_pdata_06.prg
; Version: v06
; Build Date: 2026-01-02
; Project: Mobility Dashboard v2.1.0-mobility
; Issue: #5 - Add BMAT (Brief Mobility Assessment Tool)
;
; Features: demographics, patient-list-integration, 30-day-lookback, 6-clinical-events, historical-arrays, bmat-parsing
;
...
DECLARE PROGRAM_VERSION = vc WITH CONSTANT("v06"), PROTECT
DECLARE BUILD_DATE = vc WITH CONSTANT("2026-01-02"), PROTECT
DECLARE PROGRAM_FEATURES = vc WITH CONSTANT("demographics,patient-list-integration,30-day-lookback,6-clinical-events,historical-arrays,side-panel,bmat-parsing,two-query,multi-encounter"), PROTECT
