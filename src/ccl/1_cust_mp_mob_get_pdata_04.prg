...
;===============================================================================
; Program: 1_cust_mp_mob_get_pdata_04.prg
; Version: v04
...
;
; Changelog v04:
;   - FIX: Use $ENCOUNTER_IDS directly in WHERE clause (like sepsis dashboard)
;   - REMOVED: encntr_list variable declaration and assignment
;   - Handles multiple encounter IDs correctly as value list
;===============================================================================
...
DECLARE PROGRAM_VERSION = vc WITH CONSTANT("v04"), PROTECT
DECLARE BUILD_DATE = vc WITH CONSTANT("2025-12-16"), PROTECT
DECLARE PROGRAM_FEATURES = vc WITH CONSTANT("demographics,patient-list-integration,date-filtering,5-clinical-events,two-query,multi-encounter"), PROTECT
